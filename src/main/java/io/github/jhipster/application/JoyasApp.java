...
public class JoyasApp {

    private static final Logger log = LoggerFactory.getLogger(JoyasApp.class);

    private final Environment env;

    public JoyasApp(Environment env) {
        this.env = env;
    }
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(JoyasApp.class);
